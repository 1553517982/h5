...
class Socket {
    ...
    private onSocketOpen(): void {
        ...
        if (this._connectFlag && this._needReconnect) {
            //App.MessageCenter.dispatch(GameEvent.E_SOCKET_RECONNECT);
        } else {
            //App.MessageCenter.dispatch(GameEvent.E_SOCKET_CONNECT);
        }
    ...
    private onSocketClose(): void {
        ...
        if (this._needReconnect) {
            //App.MessageCenter.dispatch(GameEvent.E_SOCKET_START_RECONNECT);
            this.reconnect();
        } else {
            //App.MessageCenter.dispatch(GameEvent.E_SOCKET_CLOSE);
        }
    }
    ...
    private onSocketError(): void {
        if (this._needReconnect) {
            ...
            //App.MessageCenter.dispatch(GameEvent.E_SOCKET_NOCONNECT);
        }
        this._isConnecting = false;
    }
    ...
    private debugInfo(str: String): void {
        //App.MessageCenter.dispatch(GameEvent.E_SOCKET_DEBUG_INFO, str);
    }
